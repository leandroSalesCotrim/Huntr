// app/components/GameCardTrophyComponent.tsx
...
interface GameCardTrophyComponentProps {
    jogo: Jogo;
    onClose: () => void;
}


const GameCardTrophyComponent: React.FC<GameCardTrophyComponentProps> = ({ jogo, onClose, }) => {
...
export default GameCardTrophyComponent;